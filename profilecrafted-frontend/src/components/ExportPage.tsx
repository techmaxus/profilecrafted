...
export default function ExportPage({ essay, onStartOver }: ExportPageProps) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto animate-fade-in">
      ...
      {/* Social Sharing - Premium Light Theme */}
      <div className="text-center mb-12">
        <h3 className="text-xl font-semibold text-light-text mb-6">Share Your Success</h3>
        <div className="flex justify-center space-x-4">
          <button
            onClick={() => handleSocialShare('twitter')}
            className="w-12 h-12 bg-blue-500 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 shadow-light-sm hover:shadow-light-md hover:scale-105"
          >
          ...
          <button
            onClick={() => handleSocialShare('linkedin')}
            className="w-12 h-12 bg-blue-700 hover:bg-blue-800 rounded-lg flex items-center justify-center transition-all duration-300 shadow-light-sm hover:shadow-light-md hover:scale-105"
          >
            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="w-12 h-12 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-all duration-300 shadow-light-sm hover:shadow-light-md hover:scale-105"
          >
            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
